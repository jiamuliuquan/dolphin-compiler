...
| H20-05 | 实际调试器及整体体验验收 | H20-04 | 完成（gdb/lldb 脚本 + DBG-01..04 + `lsp_07`；Linux gdb 实测与 Linux lane 通过，macOS lldb/远端 CI 未验证，见 [M20 报告](reports/m20-progress.md) H20-05 节） |
