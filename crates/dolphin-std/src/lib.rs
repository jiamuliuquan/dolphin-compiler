...
pub const UNITS: &[(&str, &str, &str)] = &[
    ...
    ("std.error", "<std>/error.do", include_str!("error.do")),
    ("std.io", "<std>/io.do", include_str!("io.do")),
    ("std.fs", "<std>/fs.do", include_str!("fs.do")),
    ("std.test", "<std>/test.do", include_str!("test.do")),
];
